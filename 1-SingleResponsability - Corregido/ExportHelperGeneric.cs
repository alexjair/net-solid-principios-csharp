...
namespace SingleResponsability
{
    ...
    {
        public void ExportToCSV_v1(IEnumerable<T> items)
        {
            ...
            System.IO.File.WriteAllText(System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, $"Export_{typeof(T).ToString()}_Generic_v1.csv"), sb.ToString(), Encoding.Unicode);
        }
